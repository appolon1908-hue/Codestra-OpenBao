...
func TestTransit_Export_KeyVersion_ExportsCorrectVersion(t *testing.T) {
	verifyExportsCorrectVersion(t, "encryption-key", "<CODESTRA_GITLEAKS_FIXTURE_INVALID>")
	...
	verifyExportsCorrectVersion(t, "hmac-key", "<CODESTRA_GITLEAKS_FIXTURE_INVALID>")
...
func TestTransit_Export_CorrectFormat(t *testing.T) {
	verifyExportsCorrectFormat(t, "encryption-key", "<CODESTRA_GITLEAKS_FIXTURE_INVALID>")
	...
	verifyExportsCorrectFormat(t, "hmac-key", "<CODESTRA_GITLEAKS_FIXTURE_INVALID>")
