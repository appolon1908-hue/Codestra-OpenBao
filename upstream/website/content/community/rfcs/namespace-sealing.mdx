...
However, other [seal configurations](/docs/configuration/seal)
...
Sealing stanzas for KMS and PKCS#11 follow [the existing ones](/docs/configuration/seal).
...
* In OpenBao, [Shamir's technique can be disabled](/docs/internals/architecture), so the root key can be used
