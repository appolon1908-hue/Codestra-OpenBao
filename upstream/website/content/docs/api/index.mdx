...
When using [Namespaces](../concepts/namespaces/index.mdx) the final path of the API
...
```shell-session
$ curl \
    -H "X-Vault-Token: <CODESTRA_GITLEAKS_FIXTURE_INVALID>" \
...
[proxy]: ../agent-and-proxy/proxy/index.mdx#listener-stanza
