...
```json
{
  ...
  "leader_client_key": "PRIVATE_KEY_TEST_FIXTURE_REMOVED"
}
```
...
This endpoint promotes a permanent [non-voter](../../../commands/operator/raft.mdx#parameters) to voter in the raft cluster. An optional `dr_operation_token`
...
This endpoint demotes a voter to a permanent [non-voter](../../../commands/operator/raft.mdx#parameters) in the raft cluster. An optional `dr_operation_token`
may be provided if the node is in a DR secondary cluster.
