...
see the [OpenBao AppRole method documentation](../../auth/approle.mdx).
...
```json
{
  ...
  "wrap_info": null,
  "data": {
    "secret_id_accessor": "<CODESTRA_GITLEAKS_FIXTURE_INVALID>",
    "secret_id": "<CODESTRA_GITLEAKS_FIXTURE_INVALID>",
    "secret_id_ttl": 600,
