...
```json
{
  "data": {
    ...
    "url": "otpauth://totp/openbao:4746fb81-028c-cd4e-026b-7dd18fe4c2f4?algorithm=SHA1&digits=6&issuer=openbao&period=30&secret=<CODESTRA_GITLEAKS_FIXTURE_INVALID>"
  }
}
```
